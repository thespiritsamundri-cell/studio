...
export default function IncomePage() {
  ...
  const handleConfirmCancel = async () => {
    ...
    addActivityLog({ action: 'Cancel Payment', description: `Cancelled payment of PKR ${feeToCancel.amount} for family ${feeToCancel.fatherName} (${feeToCancel.familyId}).`});
  ...
  const handleConfirmEdit = async () => {
    ...
    addActivityLog({ action: 'Edit Payment', description: `Edited payment for family ${feeToEdit.fatherName} (${feeToEdit.familyId}). Original: ${feeToEdit.amount}, New: ${editAmount}.`});
